    ...
    <div className="space-y-14">
      {rows.map((r) => (
        <motion.section
          ...
          className="overflow-hidden rounded-[34px] bg-white shadow-soft ring-1 ring-hope/10"
        >
          <div
            className={cn(
          ...
          >
            ...
            <div className="flex flex-col justify-center px-6 py-12 sm:px-10 lg:py-14">
